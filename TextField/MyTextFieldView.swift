...
class MyTextFieldView: UIView, UITextFieldDelegate {
    ...
    private let border = configure(CALayer()) {
        $0.borderColor = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1.0).cgColor
        $0.borderWidth = 1
        $0.cornerRadius = 4
    }
    ...
    let activeColorCG = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1.0).cgColor
    let inactiveColorCG = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1.0).cgColor
    let activeColor = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1.0)
    ...
    private func configureRevealButton() {
        ...
        revealButton.tintColor = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1.0)
    ...
    private func setActiveColor(_ isActive: Bool = true, animated: Bool = true) {
        ...
        let logic = {
            if isActive {
                self.label.textColor = UIColor(red: 0.9, green: 0.9, blue: 0.9, alpha: 1.0)
                self.revealButton.tintColor = UIColor(red: 0.4, green: 0.5, blue: 0.5, alpha: 1.0)
                self.border.borderColor = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1.0).cgColor
            } else {
                self.label.textColor = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1.0)
                self.revealButton.tintColor = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1.0)
                self.border.borderColor = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 0.7).cgColor
            }
        }
        if animated {
