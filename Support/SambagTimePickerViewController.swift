...
public class SambagTimePickerViewController: UIViewController {
    ...
    public override func loadView() {
        ...
        okayButton.setTitle(NSLocalizedString("ok", comment: "a comment"), for: .normal)
        ...
        cancelButton.setTitle(NSLocalizedString("can", comment: "a comment"), for: .normal)
    ...
    public override func viewDidLayoutSubviews() {
        ...
        let wheelWidth: CGFloat = is24Format ? 72 : 66
